    ...
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table class="order-item" v-for="item in orderList" :key="item.id">
          ...
          <tbody>
          <tr v-for="(item1,index) in item.orderDetailList" :key="item1.id">
            <td width="60%">
              <div class="typographic">
                <img :src="item1.imgUrl" style="width: 100px; height: 100px">
      ...
      <div class="choose-order">
        <Pagination :pageNo="page" :pageSize="limit" :total="orderListInfo.total" :continues="5" @getPageNo="getPageNo"></Pagination>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
...
export default {
  ...
  computed: {
    ...mapState('trade', ['orderListInfo']),
    orderList () {
      return this.orderListInfo.records || []
    }
  },
  mounted () {
    const { page, limit } = this
    this.$store.dispatch('trade/getMyOrderList', { page, limit })
  },
  methods: {
    // 获取当前页的订单信息
    getPageNo (val) {
