...
<!--            属性-->
        ...
        <!--selector-->
        <SearchSelector @addTrademark="addTrademarkLable" @attrInfo="attrInfo"></SearchSelector>
        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:flag1}" @click="changeOrder(1)">
                  <a href="#" >
                    综合
                    <span v-show="flag1&&!flag2">⬆</span>
                    <span v-show="flag1&&flag2">⬇</span>
                  </a>
                </li>
                <li :class="{active:!flag1}" @click="changeOrder(2)">
                  <a href="#">
                    价格
                    <span v-show="!flag1&&!flag2">⬆</span>
                    <span v-show="!flag1&&flag2">⬇</span>
...
export default {
  ...
  methods: {
    ...
    changeOrder (val) {
      if (this.flag2) {
        this.searchParams.order = val + (this.searchParams.order.charAt(0) === val.toString() ? ':asc' : 'desc')
      } else {
